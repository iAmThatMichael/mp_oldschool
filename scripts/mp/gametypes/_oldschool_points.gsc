...
function get_spawn_points()
{
	...
	switch( GetDvarString( "mapname" ) )
	{
		case "mp_biodome": // Aquarium
			a_spawn_points = get_spawn_points_biodome();
			break;
		case "mp_spire": // Breach
			a_spawn_points = get_spawn_points_spire();
			break;
		case "mp_sector": // Combine
			a_spawn_points = get_spawn_points_sector();
			break;
		case "mp_apartments": // Evac
			a_spawn_points = get_spawn_points_apartments();
			break;
		case "mp_chinatown": // Exodus
			a_spawn_points = get_spawn_points_chinatown();
			break;
		case "mp_veiled": // Fringe
			a_spawn_points = get_spawn_points_veiled();
			break;
		case "mp_havoc": // Havoc
			a_spawn_points = get_spawn_points_havoc();
			break;
		case "mp_ethiopia": // Hunted
			a_spawn_points = get_spawn_points_ethiopia();
			break;
		case "mp_infection": // Infection
			a_spawn_points = get_spawn_points_infection();
			break;
		case "mp_metro": // Metro
			a_spawn_points = get_spawn_points_metro();
			break;
		case "mp_redwood": // Redwood
			a_spawn_points = get_spawn_points_redwood();
			break;
		case "mp_stronghold": // Stronghold
			a_spawn_points = get_spawn_points_stronghold();
			break;
		case "mp_nuketown_x": // Nuk3town
			a_spawn_points = get_spawn_points_nuketown();
			break;
		/***********DLC1***********/
		case "mp_rise": // Rise
			break;
...
function get_spawn_points_biodome()
{
	a_spawn_points = [];
...
function get_spawn_points_spire()
{
	a_spawn_points = [];
...
function get_spawn_points_sector()
{
	a_spawn_points = [];
	...
	ARRAY_ADD( a_spawn_points, create_spawn( "perk", (551.289, 751.087, 155.902) ) );
...
function get_spawn_points_apartments()
{
	a_spawn_points = [];
...
function get_spawn_points_chinatown()
{
	a_spawn_points = [];
...
function get_spawn_points_veiled()
{
	a_spawn_points = [];
...
function get_spawn_points_havoc()
{
	a_spawn_points = [];
...
function get_spawn_points_ethiopia()
{
	a_spawn_points = [];
...
function get_spawn_points_infection()
{
	a_spawn_points = [];
...
function get_spawn_points_metro()
{
	a_spawn_points = [];
...
function get_spawn_points_redwood()
{
	a_spawn_points = [];
...
function get_spawn_points_stronghold()
{
	a_spawn_points = [];
...
function get_spawn_points_nuketown()
{
	a_spawn_points = [];
